...
import { useSecreatryLoginMutation } from "@/redux/api/auth.api";
...
const SecretaryLoginForm = () => {

    const [secreatrySignIn, { isSuccess, isLoading, isError, error }] = useSecreatryLoginMutation()

    const navigate = useNavigate()

    const formik = useFormik({
        initialValues: {
            email: "societysathi@gmail.com",
            password: "123",
        },
    ...
    useEffect(() => {
        if (isSuccess) {
            toast.success("Secreatry Login Successfully")
            navigate("/secretary")
        }
    }, [isSuccess])
