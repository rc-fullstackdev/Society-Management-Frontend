...
import { Menu, X, IndianRupee, Building, Wallet, AlertCircle, Calendar, ClipboardList, } from "lucide-react";
import { useSelector } from "react-redux";
import { toast } from "react-toastify";
import { useResidentialLogoutMutation } from "@/redux/api/auth.api";
...
const ResidentialDashboard = () => {
    ...
    const [residentialLogout, { isSuccess }] = useResidentialLogoutMutation()
    ...
    const menuItems = [
        { label: "Pay Maintenance", path: "/residential/payment", icon: IndianRupee },
        { label: "Payment Details", path: "/residential/payment/history", icon: Wallet },
        { label: "Flat Details", path: "/residential/flat/details", icon: Building },
        { label: "All Event", path: "/residential/society/event", icon: Calendar },
        { label: "Complaint Details", path: "/residential/society/details", icon: AlertCircle },
        { label: "My Visitors", path: "/residential/resident/guest", icon: ClipboardList },
        { label: "Facility Booking", path: "/residential/get/facility/booking", icon: ClipboardList },
    ];
        ...
        <div className="flex min-h-screen bg-gray-100">
            ...
            >
                ...
                <div className="flex items-center justify-center lg:justify-start gap-3 p-4 border-b border-blue-500">
                    ...
                    <img
                        src={residential?.residentialProfile || "/default-user.png"}
                        alt="Profile"
