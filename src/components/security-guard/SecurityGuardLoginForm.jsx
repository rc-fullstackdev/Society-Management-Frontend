...
import { useSecurityGuardLoginMutation } from "@/redux/api/auth.api";
...
const SecurityGuardLoginForm = () => {

    const [guardSignIn, { isSuccess, isLoading, isError, error }] = useSecurityGuardLoginMutation()
    ...
    useEffect(() => {
        if (isSuccess) {
            toast.success("Security Guard Login Successfully")
...
export default SecurityGuardLoginForm;